...
export interface Cliente {
  ...
  telefone: string; email: string; criadoEm: string;
}
...
export interface Veiculo {
  ...
  modelo: string; ano: number; cor: string; clienteId: number;
}

export interface CreateVeiculoDto {
  placa: string; marca: string; modelo: string;
  ano: number; cor: string; clienteId: number;
}
...
export interface OrdemServico {
  id: number; descricao: string; status: StatusOrdem;
  valorEstimado: number; valorFinal?: number; observacoes?: string;
  abertaEm: string; concluidaEm?: string;
  veiculoId: number; placaVeiculo: string; nomeCliente: string;
}

export interface CreateOrdemDto {
  descricao: string; valorEstimado: number;
  observacoes?: string; veiculoId: number;
}

export interface UpdateStatusOrdemDto {
  status: StatusOrdem; valorFinal?: number;
}
